package com.ucl_finalproject.audiocommentary.helper;
...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "audiocommentary";
     ...
     * */
    public void addUser(String name, String email, int commentator, String uid, String created_at) {
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put(KEY_NAME, name); // Name
        values.put(KEY_EMAIL, email); // Email
        values.put(KEY_COMMENTATOR,commentator); // Commentator Status
