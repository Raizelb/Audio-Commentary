...
require_once 'WebScripts/DB_Functions.php';
require 'WebScripts/libs/Slim/Slim.php';
...
$app->post('/chat_rooms/:id/message', function($chat_room_id) {
    ...
    if ($response['error'] == false) {
        require_once __DIR__ . 'WebScripts/libs/gcm/gcm.php';
        require_once __DIR__ . 'WebScripts/libs/gcm/push.php';
        $gcm = new GCM();
        $push = new Push();
