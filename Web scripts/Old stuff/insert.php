...
if($_SERVER['REQUEST_METHOD']=='POST'){
 ...
 $sql = "SELECT * FROM audiocommentary_users WHERE username='$username' OR email='$email'";
 ...
 $sql = "INSERT INTO audiocommentary_users (name,username,password,email) VALUES('$name','$username','$password','$email')";
